               ...
               <nav class="navbar navbar-expand-xl bg-transparent px-0 w-100">
                     ...
                     <div class="d-block d-xl-none">
                        <ul class="navbar-nav flex-row ml-auto align-items-center justify-content-lg-end flex-wrap py-2">            
                           ...
                           <li class="nav-item ml-auto w-100 w-sm-auto">
                              ...
                              Advertise
                              <img src="{{asset('web/images/add-listing-icon.png')}}" alt="Add listing" class="ml-1">
                              </a>
                           </li>
                        </ul>
                     </div>
                  ...
                  <div class="ml-auto d-none d-xl-block order-xl-2">
                     <ul class="navbar-nav flex-row ml-auto align-items-center justify-content-lg-end flex-wrap py-2">
                        ...
                        <li class="nav-item">
                           <a class="btn btn-outline-light btn-lg text-white rounded-lg bg-hover-primary border-hover-primary hover-white d-none d-lg-block" href="dashboard-add-new-property.html">
                           Advertise
                           <img src="{{asset('web/images/add-listing-icon.png')}}" alt="Add listing" class="ml-1 normal-button-icon">
                           <img src="{{asset('web/images/add-listing-icon-primary.png')}}" alt="Add listing" class="ml-1 sticky-button-icon">
                           </a>
                           <a class="btn btn-primary btn-lg d-block d-lg-none" href="dashboard-add-new-property.html">
                           Add listing
                           <img src="{{asset('web/images/add-listing-icon.png')}}" alt="Add listing" class="ml-1">
                           </a>
                        </li>
